...
public class Prologue : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        contents.Add("Once upon a time, there was a biotechnology laboratory that conducted inhumane experiments on many animals in order to study illegal drugs.");
